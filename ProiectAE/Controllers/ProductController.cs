...
namespace ProiectAE.Controllers
{
    ...
    public class ProductController : Controller
    {
        ...
        private readonly ProiectContext context;

        public ProductController(IWebHostEnvironment hostEnvironment, ProiectContext context)
        {
